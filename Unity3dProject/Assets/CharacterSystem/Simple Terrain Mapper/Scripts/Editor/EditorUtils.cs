...
public class EditorUtils 
{
	...
	{
		return TextField(textFieldValue, label, 0, FieldTypeEnum.WholeLine, false);
	}
	...
	{
		return TextField(textFieldValue, string.Empty, 0, fieldType);
	}
	
	public static string TextField(string textFieldValue, string label, FieldTypeEnum fieldType)
	{
		return TextField(textFieldValue, label, 0, fieldType);
	}
	...
	{
		return IntField(intFieldValue, label, 0, fieldType);
	}
	...
	{
		return IntField(intFieldValue, string.Empty, 0, fieldType, true);
	}
	...
	{
		return Toggle(floatFieldValue, string.Empty, 0, fieldType, true);
	}
	...
	{
		return IntPopup(intFieldValue, list, string.Empty, 0, fieldType, false);
	}
	...
	public static void IItemEditor(IItem item)
	{
		...
		item.ID = IntField(item.ID, "ID", 70, FieldTypeEnum.BeginningOnly);
		
		item.Name = TextField(item.Name, "Name", 400, FieldTypeEnum.EndOnly);
